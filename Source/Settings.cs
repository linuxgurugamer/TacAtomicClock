...
namespace Tac
{
    class Settings
    {
        ...
        public Settings()
        {
            ...
            this.Log("Kerbin Sidereal Rotation Period = " + kerbinSiderealRotationPeriod
        ...
        public void Load(ConfigNode config)
        {
            ...
            showMonth = Utilities.GetValue(config, "showMonth", showMonth);
            ...
            kerbinDaysPerYear = Utilities.GetValue(config, "kerbinDaysPerYear", kerbinDaysPerYear);
        ...
        public void Save(ConfigNode config)
        {
            ...
            config.AddValue("showMonth", showMonth);
            ...
            config.AddValue("kerbinDaysPerYear", kerbinDaysPerYear);
